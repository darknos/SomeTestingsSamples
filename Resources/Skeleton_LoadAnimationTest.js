...
function createSkeletonAtPosition(posX, posY)
{
	...
	if(mySkeleton == null)
	{
        ...
        mySkeleton = animo.createSkeletonWithFile("graphics/RES_kot/skeletons/Kot_Skeleton"+suffix+".json",
                                                        scene);     
        ...
        // load skeleton atlas based on device
        var animToLoadPath = "graphics/RES_kot/skeletons/animations/" + 'Ukol' + suffix + ".json";
		...
		var animToLoadName = "Ukol";//animNames[currentAnimIdx];
		...
		// load skeleton atlas based on device
        var animToLoadPath = "graphics/RES_kot/skeletons/animations/" + animToLoadName + suffix + ".json";
        
        var skeletonAnimation = animo.createSkeletalAnimationWithFile(animToLoadPath);
        mySkeleton.transitionToAnimationInTime(skeletonAnimation, 0.5); 
    }
}
